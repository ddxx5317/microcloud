...
import com.ddxx.microcloud.fallback.FeignClientFallbackFactory;
import com.ddxx.vo.Dept;

@FeignClient(name="microcloud-provider-dept-8001",fallbackFactory=FeignClientFallbackFactory.class)
